...
public class Student extends User {
    ...
    public List<String> viewapprovedcourses(Map<String, Course> availableCourses) {
        List<String> approvedCourseIds = new ArrayList<>();
        ...
        for (String courseId : this.enrolledCourses) {
            ...
            if (course != null && "Approved".equals(course.getStatus())) {
                approvedCourseIds.add(courseId);
            }
        }

        return approvedCourseIds;
    }
